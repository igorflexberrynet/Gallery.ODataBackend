...
CREATE TABLE [Picture] (
	 ...
	 [Author_m0] UNIQUEIDENTIFIER  NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Picture] ADD CONSTRAINT [Picture_FAuthor_0] FOREIGN KEY ([Author_m0]) REFERENCES [Author]
CREATE INDEX Picture_IAuthor_m0 on [Picture] ([Author_m0])
